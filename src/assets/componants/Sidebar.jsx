...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar-container  d-flex  flex-column align-items-lg-center align-items-md-start mx-md-2 ">
      ...
      <div className="catelog d-flex flex-column">
        <div
          className={`categories rounded-4 ${
        ...
        <div className="categories  rounded-4">
